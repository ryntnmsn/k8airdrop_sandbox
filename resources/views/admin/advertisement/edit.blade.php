...
<form action="{{ route('admin.ads.update',$ad['id'])}}" method="post" enctype="multipart/form-data" class="pb-5">
  @method('PUT')
  @csrf
  <div class="row">
    <div class="col"><h3>Update Advertisement</h3></div>
    ...
    <div class="col">
      ...
      <select class="form-control" name="language_id" id="language_id">
        @foreach($languages as $langauge)
          <option value="{{$langauge->id}}" @selected($ad['language_id'] == $langauge->id) >{{$langauge->name}}</option>
        @endforeach
      </select>
    </div>
  </div>
  <div class="row mt-5">
    <div class="col">
      ...
      <select class="form-control" name="layout" id="layout">
        <option value="left" @selected($ad['layout'] == 'left')>Left</option>
        <option value="right" @selected($ad['layout'] == 'right')>Right</option>
      </select>
    </div>
  </div>
  ...
  <div class="row mt-5">
    ...
    <div class="col">
      <div>
        ...
        <input type="text" class="form-control" id="img_website" name="img_website" value="{{$ad['img_website']}}" required>
      </div>
    </div>
  </div>
  <div class="row mt-5">
    ...
    <div class="col">
      <div>
        ...
        <input type="text" class="form-control" id="video_website" name="video_website" value="{{$ad['video_website']}}" required>
      </div>
    </div>
  </div>
</form>
