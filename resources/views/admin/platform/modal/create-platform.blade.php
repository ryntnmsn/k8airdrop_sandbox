<div class="modal fade" id="createPlatformModal" tabindex="-1" aria-labelledby="createPlatformLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content ">
            <div class="modal-header bg-custom-dark">
                <h5 class="modal-title fw-bold" id="createPlatformLabel">Add new platform</h5>
