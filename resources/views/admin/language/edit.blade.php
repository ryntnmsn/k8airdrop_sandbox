...
<form action="{{ route('admin.languages.update',$language->id)}}" method="post" enctype="multipart/form-data" class="pb-5">
  @method('PUT')
  @csrf
  <div class="row">
  ...
  <div class="row mt-5">
    <div class="col">
      <div>
        ...
        <input type="text" class="form-control" id="name" name="name" value="{{$language->code}}">
      </div>
    </div>
  </div>
  <div class="row mt-5">
    <div class="col">
      <div>
        ...
        <input type="text" class="form-control" id="code" name="code" value="{{$language->name}}">
      </div>
    </div>
  </div>
</form>
