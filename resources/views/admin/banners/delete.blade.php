<div class="modal fade" id="deleteBannerModal" tabindex="-1" aria-labelledby="deleteBannerLabel" aria-hidden="true">
...
<script>
    ...
    var modalBodyID = deleteBannerModal.querySelector('.modal-body #id')
